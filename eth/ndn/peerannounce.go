...
func (l *peersendingloop) sendAck(i *ndn.Interest, producer ndnapp.AppProducer) {
	l.ackCh <- &PendingAck{
		interest:	i,
		producer:	producer,
	}
...
func (l *peersendingloop) sendInterest(items []*PushItem) chan error {
	...
	if err := l.c.asendEthInterest(l.p, msg, false, func(req ndnapp.Request, route interface{}, rep ndnapp.Response, err1 error) {
